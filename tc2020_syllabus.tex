...
\begin{document}
  ...
  \noindent\textbf{Páginas del curso:}
  ...
  Ésta es una lista de recursos que pueden ser de utilidad durante el curso.
  ...
  {\large Lenguajes libres de contexto}\\[2ex]
  ...
  \subtopic ~Análisis sintáctico ascendente\\[2.5ex]
  {\large Lenguajes recursivamente numerables}\\[2ex]
  ...
  \vspace*{.15in}
  \noindent\textbf{Política de evluación:} Tareas (30\%), Quizzes Examen de medio término (20\%), Examen Final (20\%). %Four Projects (40\% = 4 * 10\%)
