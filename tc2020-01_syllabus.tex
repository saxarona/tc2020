...
\newcommand{\theplace}{A3-302\footnotemark}

\footnotetext{Si tu clase es en formato regional, recuerda que la clase es vía \texttt{zoom}.}
...
\begin{document}
  ...
  Usualmente puedes encontrarme los días lunes de 5:00 a 6:00 p.m. en la oficina (CT-536, CETEC Sur).
  ...
  Examen de medio término \dotfill ~8 de octubre \\
