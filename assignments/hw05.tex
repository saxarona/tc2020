...
\begin{enumerate}
    \item Tras haber realizado correctamente los AFNs de la Tarea 4, escribe ahora \textbf{dos} equivalencias en Expresiones Regulares \textit{genéricas} (las que vimos en clase).
