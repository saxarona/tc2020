...
\begin{description}
    \item[a)] Diseña un AFD correcto y completo para el lenguaje de las palabras en $\{a,b\}$ que contienen la subcadena \texttt{abba} (10 \%) y escribe su definición formal completa (2 \%). Después, da tres ejemplos de palabras que sean aceptadas y otros tres de palabras no aceptadas (3 \%).
\end{description}
